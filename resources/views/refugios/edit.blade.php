        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('web.refugios.update', $refugio->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="nombre_refugio" class="block mt-1 w-full"
                                              type="text" name="nombre_refugio"
                                              :value="$refugio->nombre_refugio" required />
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="direccion" class="block mt-1 w-full"
                                          ...
                                          :value="$refugio->direccion" required />
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="telefono_contacto" class="block mt-1 w-full"
                                              ...
                                              :value="$refugio->telefono_contacto" />
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="descripcion" rows="3"
                                      class="block mt-1 w-full border-gray-300 rounded-md">{{ $refugio->descripcion }}</textarea>
                        </div>
